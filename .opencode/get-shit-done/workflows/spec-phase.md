...
```bash
INIT=$(node "C:/Users/uik03287/AI_MT-Service/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/uik03287/AI_MT-Service/.opencode/get-shit-done/templates/spec.md.
