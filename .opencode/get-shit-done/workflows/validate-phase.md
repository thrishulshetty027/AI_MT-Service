...
```
Task(
  prompt="Read C:/Users/uik03287/AI_MT-Service/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/uik03287/AI_MT-Service/.opencode/get-shit-done/templates/VALIDATION.md`
