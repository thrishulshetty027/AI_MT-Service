...
- **Global scope**: `C:/Users/uik03287/AI_MT-Service/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/uik03287/AI_MT-Service/.opencode/notes/`)
...
2. Glob `C:/Users/uik03287/AI_MT-Service/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/uik03287/AI_MT-Service/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/uik03287/AI_MT-Service/.opencode/notes/` — works in any directory
